...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitzenyPlus/BitZenyPlus>";
    const std::string URL_WEBSITE = "<https://bitzeny.tech>";
